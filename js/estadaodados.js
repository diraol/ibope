...
function atualiza_grafico(argumentos) {
    ...
    if (pergunta == "aprova_dilma") legend = chart.addLegend(-200, 10, 165, 220, "right")    
    else legend = chart.addLegend(-200, 10, 195, 220, "right");
    ...
    chart.draw(800); // Desenhando novo gráfico com animação durando 800 ms
